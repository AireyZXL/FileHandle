...
/**
 * Created by zxlei1 on 2017/9/27.
 */
...
public class UploadHandleServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //设置工厂的缓冲区的大小,当上传文件的大小超过缓冲区的大小时,就会生成一个临时文件存放到指定的临时目录中
            ...
            //设置上传单个文件的大小的最大值，目前设置为1024*1024字节，即20MB
            ...
            for (FileItem item : list) {
                ...
                if (item.isFormField()) {
                    ...
                    System.out.println("上传文件的拓展名是: " + fileExtName);
                    //获取item中上传文件的输入流
            ...
            request.getRequestDispatcher("/backend/message.jsp").forward(request, response);
            e.printStackTrace();
            return;
    ...
    /**
     * @param saveFileName 文件名，要根据文件名生成存储目录
